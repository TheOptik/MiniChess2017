...
public class Board {
	...
	public Board move(Move move) {
		...
		if (move == null) {
			...
			// previousStates.push(new BoardState(isGameOver, isDraw, promotionInLastTurn,
			// winner, fields[move.to.x][move.to.y].figure));
		}
		...
		if (move.player.equals(activePlayer)) {
			...
			// if (move.to.y == 0 && this.fields[move.to.x][move.to.y].figure ==
			// Figure.WHITE_PAWN) {
			...
			// if (move.to.y == 5 && this.fields[move.to.x][move.to.y].figure ==
			// Figure.BLACK_PAWN) {
	...
	private class BoardState {
		...
		public BoardState(boolean isGameOver, boolean isDraw, Player winner, Figure capturedFigure) {
			// public BoardState(boolean isGameOver, boolean isDraw, boolean
			// promotionInLastTurn,
