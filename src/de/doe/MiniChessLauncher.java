...
public class MiniChessLauncher {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		playHeuristicVSNegaMax();

	}

	private static void playHeuristicVSNegaMax() {
		Board board = new Board();

		AbstractPlayer player1 = new NegaMaxPlayer(Player.WHITE, 5);
		AbstractPlayer player2 = new NegaMaxPlayer(Player.BLACK, 3);
