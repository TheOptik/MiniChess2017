...
public class NegaMaxPlayerTest {
  ...
  public void PawnCaptureKing() throws Exception {
    ...
    Board expected = new Board(TestUtils.getMultilineString("2 B", ".P...", ".....", ".....", ".....", ".....", "....."));
  ...
  public void KingsEscape() throws Exception {
    Board board = new Board(TestUtils.getMultilineString("1 W", ".....", "r....", "..K.", "..p..", ".r...", "....."));
    Board expected = new Board(TestUtils.getMultilineString("2 B", ".....", "r....", ".....", "..pK.", ".r...", "....."));
